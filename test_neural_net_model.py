...
class TestNeuralNetModel(unittest.TestCase):
    ...
    def test_generate_tokens_stop_token_halts_early(self, layers: list[dict], input_context: list,
                                                    block_size: int, max_new_tokens: int):
        model = NeuralNetworkModel("test", Mapper(layers, {"sgd": {}}))
    ...
    def test_generate_tokens_stream_stop_token_halts_early(self, layers: list[dict], input_context: list,
                                                           block_size: int, max_new_tokens: int):
        model = NeuralNetworkModel("test", Mapper(layers, {"sgd": {}}))
